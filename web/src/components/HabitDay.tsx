...
export function HabitDay({ amount = 0, defaultCompleted = 0, date }: HabitDayProps) {
    ...
    return (
        <Popover.Root>
            <Popover.Trigger
                className={clsx("w-10 h-10 bg-zinc-900 border-2 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background border-zinc-800 rounded-lg", {
